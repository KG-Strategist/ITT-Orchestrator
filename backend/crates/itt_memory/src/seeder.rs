...
pub async fn run(manager: &Arc<CorpusManager>) {
    ...
    let rules = vec![
        MdmRule {
            ...
            description: "Detects Indian Aadhaar format".to_string(),
        ...
        MdmRule {
            ...
            description: "Detects Indian PAN Card format".to_string(),
        ...
        MdmRule {
            ...
            description: "Detects standard email address formats".to_string(),
